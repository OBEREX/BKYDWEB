...
import { ChevronRight, Menu, X, BookOpen, Users, Briefcase, CheckCircle2, ArrowRight } from 'lucide-react';
...
export default function App() {
  ...
  // If on Projects page, show Projects component
  if (currentPage === 'projects') {
    return <Projects onNavigate={handleNavigate} />;
  }

  // Otherwise show Services page
  return (
...
// Navbar Component
function Navbar({ mobileMenuOpen, setMobileMenuOpen, onNavigate, currentPage }: { 
