import svgPaths from "./svg-nf5cf90h5x";
...
function Frame65() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-center justify-center relative shrink-0">
      <div className="flex flex-col font-['General_Sans:Medium',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[48px] text-nowrap text-white">
  ...
  return (
    <div className="bg-[#353851] h-[349px] opacity-90 relative shrink-0 w-[1440px]">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col gap-[40px] h-[349px] items-center justify-center px-[100px] py-[271px] relative w-[1440px]">
...
function Frame5() {
  return (
    <div className="h-[662.325px] relative shrink-0 w-full">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[662.325px] items-center justify-center p-[100px] relative w-full">
          <Frame7 />
        </div>
      </div>
    </div>
  ...
  return (
    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 226 58">
      <g id="_2965621218592">
        ...
        <g id="Group">
          <path clipRule="evenodd" d={svgPaths.p1974b300} fill="var(--fill-0, #F1AE1E)" fillRule="evenodd" id="Vector_2" />
...
function Frame40() {
  return (
    <div className="h-[934px] relative shrink-0 w-full">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[934px] items-center justify-center p-[100px] relative w-full">
          <Frame39 />
        </div>
      </div>
    </div>
...
function Frame49() {
  return (
    <div className="[grid-area:1_/_1] box-border content-stretch flex flex-col gap-[30px] items-center justify-center ml-0 mt-0 overflow-clip p-[100px] relative w-[1440px]">
      <Frame48 />
      <Frame55 />
    </div>
  );
...
function Frame52() {
  return (
    <div className="[grid-area:1_/_1] bg-zinc-100 box-border content-stretch flex flex-col gap-[30px] items-center justify-center ml-0 mt-[923px] overflow-clip p-[100px] relative w-[1440px]">
      <Frame51 />
      <BodyE />
    </div>
  );
...
function Frame53() {
  return (
    <div className="[grid-area:1_/_1] bg-[#1559cb] box-border content-stretch flex h-[68px] items-center justify-between ml-0 mt-[2137.51px] px-[50px] py-[20px] relative w-[1440px]">
      <div className="relative shrink-0 size-[24px]" data-name="Interface, Essential/asterisk-circle">
        <Group27 />
      </div>
      <div className="flex flex-col font-['General_Sans:Semibold',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[18px] text-center text-nowrap text-white">
...
function Frame54() {
  return (
    <div className="[grid-area:1_/_1] bg-[#020e37] box-border content-stretch flex flex-col gap-[30px] items-center justify-center ml-0 mt-[2205.51px] overflow-clip p-[100px] relative w-[1440px]">
      <Frame62 />
    </div>
  );
}
